...
<head>
    ...
    <title>gopinath g - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/O/Pictures/Gallery/owner/naaa/IMG_20250310_190050.jpg alt="gopinath g" class="profile-picture">
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="storage/emulated/O/DCIM/Naan muthalvan gopi.pdf class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="gopinath g">gopiruban2005@gmail.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 gopinath g. All Rights Reserved.</p>
    </footer>
